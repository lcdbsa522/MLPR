...
__all__ = ['resnet18_fp', 'resnet34_fp', 'resnet18_quant', 'resnet34_quant']
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            if block == QBasicBlock:
                conv_func = lambda inp, outp, s: Qconv1x1(self.args, inp, outp, s)
            else:
                conv_func = conv1x1

            downsample = nn.Sequential(
                conv_func(self.inplanes, planes * block.expansion, stride),
                norm_layer(planes * block.expansion),
            )

        layers = []
        if block == QBasicBlock:
            layers.append(block(self.args, self.inplanes, planes, stride, downsample,
    ...
    def _forward_impl(self, x, quant_params):
    ...
    def forward(self, x, quant_params=None):
        return self._forward_impl(x, quant_params)
...
def resnet18_fp(args, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(args, 'resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)

def resnet34_fp(args, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(args, 'resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs)
...
def resnet18_quant(args, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(args, 'resnet18', QBasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs)
...
def resnet34_quant(args, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(args, 'resnet34', QBasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs)